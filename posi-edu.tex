...
\begin{itemize}
	\item Researcher at Laboratorio Detección de Partículas y Radiación (LabDPR), Gerencia de Física (GF), Gerencia de Área de Investigaciones y Aplicaciones No Nucleares (GAIYANN), Centro Atómico Bariloche (CAB), Comisión Nacional de Energía Atómica (CNEA).
...
\begin{itemize}
	\item Investigador en el Laboratorio Detección de Partículas y Radiación (LabDPR), Gerencia de Física (GF), Gerencia de Área de Investigaciones y Aplicaciones No Nucleares (GAIYANN), Centro Atómico Bariloche (CAB), Comisión Nacional de Energía Atómica (CNEA).
